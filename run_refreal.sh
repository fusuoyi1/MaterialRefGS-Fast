...
if [ "$gpuid" -ge 0 ]; then
    ...
    # change this to your scene name
    scene=gardenspheres
    #data_dir=/data14_2/tjm/code/ref-gaussian/data/refreal
    data_dir=/home/shiqingaoxue/文档/3DGS/MaterialRefGS/datasets/ref_real/gardenspheres
    #output_dir=output_refreal
    output_dir=/home/shiqingaoxue/文档/3DGS/MaterialRefGS/output_refreal
    
    # Prior paths
    #metric3d_path=/data14_2/tjm/code/Metric3D/output
    metric3d_path=/home/shiqingaoxue/文档/3DGS/MaterialRefGS/Metric3D/output
    #ref_score_path=/data14_2/tjm/code/ref-gaussian-tjm/tmp_ref_scores_merge_mask2
    ref_score_path=/home/shiqingaoxue/文档/3DGS/MaterialRefGS/ref_score
