...
if os.name == "posix":
    c_flags = ['-O3', '-std=c++14', '-fopenmp', '-march=native']
elif os.name == "nt":
    c_flags = ['/O2', '/std:c++17', '/openmp']
...
'''
setup(
    name='raytracing_brdf', # package name, import this to use python API
    version='0.1.0',
    ...
    ext_modules=[
        CUDAExtension(
            name='_raytracing_brdf', # extension name, import this to use CUDA API
