...
public:
    ...
    virtual void trace(at::Tensor rays_o, at::Tensor rays_d, at::Tensor positions, at::Tensor normals, at::Tensor depth, at::Tensor triangle_indices) = 0;
    virtual at::Tensor get_triangles() = 0;
    virtual void create_faceids_mappings() = 0;
    virtual at::Tensor get_triangels_ids_mapping() = 0;
};
